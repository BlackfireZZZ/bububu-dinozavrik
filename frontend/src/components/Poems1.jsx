        ...
        <div className="poems__container">
            <div className="poems__left">
                <div className="poems__block__text">
                    <p>
                        Вот стихи, написанные или прочитанные когда-то тебе. Да, я менялся, мы с тобой с некоторыми вещами там не согласны. Но мои чувства к тебе там искренние, поэтому хотя бы они заслуживают быть здесь.
                    </p>
                </div>
