    ...
    return (
        <div className="walk2-container">
            <div className="left-column2">
                <div className="block__text2" style={{fontSize: '18px'}}>
                ...
                <div className="image-container2">
                    ...
                    <div className="caption">Мы гуляем по Музеону и брызгаемся у фонтанчиков</div>
                </div>
            </div>
            <div className="right-column2">
                <div className="top-image-container2">
                    <img src={require("../assets/walk3.jpg")} alt="Big" className="big-image2" />
                    <div className="caption">Мы сбежали после поездки и стоим на том красивом мосте</div>
                </div>
